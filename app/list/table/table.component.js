System.register(['@angular/core', '@angular/router', '@osw/table/table', './bangumi.cell.component'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            EpiListTableComponent = (function () {
                function EpiListTableComponent(router) {
                    this.router = router;
                    this.touches = {
                        startX: 0,
                        startY: 0,
                    ...
                    this.scrolling = true;
                    this.cells = [
                        new table_1.Cell("My item 0", ""),
                        new table_1.Cell("My item 1", ""),
                        new table_1.Cell("My item 2", ""),
                        new table_1.Cell("My item 3", ""),
                        new table_1.Cell("My item 4", ""),
                        new table_1.Cell("My item 5", ""),
                        new table_1.Cell("My item 6", ""),
                        new table_1.Cell("My item 7", ""),
                        new table_1.Cell("My item 8", ""),
                    ];
                }
                EpiListTableComponent.prototype.onTouchStart = function (event) {
                    this.touches.startX = event.targetTouches[0].pageX;
                    this.touches.startY = event.targetTouches[0].pageY;
                    this.scrolling = false;
                };
                EpiListTableComponent.prototype.onTouchMove = function (event) {
                ...
                EpiListTableComponent.prototype.onSelected = function (cell) {
                    if (this.scrolling) {
                        return;
                    }
                    this.router.navigate(['/home', cell.path]);
                };
                EpiListTableComponent = __decorate([
                    core_1.Component({
                ...
                ], EpiListTableComponent);
                return EpiListTableComponent;
            }());
            exports_1("EpiListTableComponent", EpiListTableComponent);
        }
    }
});
