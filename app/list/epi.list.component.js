        ...
        execute: function() {
            EpiListComponent = (function () {
                function EpiListComponent() {
                    this.title = "List";
                    this.cells = [
                        new cell_component_1.Cell("My item 0"),
                        new cell_component_1.Cell("My item 1"),
                        new cell_component_1.Cell("My item 2"),
                        new cell_component_1.Cell("My item 3"),
                        new cell_component_1.Cell("My item 4"),
                        new cell_component_1.Cell("My item 5"),
                        new cell_component_1.Cell("My item 6"),
                        new cell_component_1.Cell("My item 7"),
                        new cell_component_1.Cell("My item 8"),
                        new cell_component_1.Cell("My item 9"),
                        new cell_component_1.Cell("My item 10"),
                        new cell_component_1.Cell("My item 11"),
                    ];
                }
...
//# sourceMappingURL=epi.list.component.js.map